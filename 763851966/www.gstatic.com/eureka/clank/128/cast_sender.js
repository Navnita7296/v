(function() {
    ...
    da("Symbol.iterator", function(a) {
        ...
        for (var b = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c = 0; c < b.length; c++) {
            var d = ca[b[c]];
            typeof d === "function" && typeof d.prototype[a] != "function" && h(d.prototype, a, {
                configurable: !0,
                writable: !0,
                value: function() {
                    return ea(aa(this))
    ...
    var ea = function(a) {
        ...
        m;
    if (typeof Object.setPrototypeOf == "function") m = Object.setPrototypeOf;
    else {
        var n;
        a: {
            var ia = {
    ...
    */
    var q = this || self,
        ...
        w = function(a, b, c) {
            w = Function.prototype.bind && Function.prototype.bind.toString().indexOf("native code") != -1 ? na : oa;
    ...
    */
    ...
    chrome.cast.hb = function(a, b, c, d) {
        this.label = a;
        a = b;
        wa.test(a) && (a.indexOf("&") != -1 && (a = a.replace(qa, "&amp;")), a.indexOf("<") != -1 && (a = a.replace(ra, "&lt;")), a.indexOf(">") != -1 && (a = a.replace(sa, "&gt;")), a.indexOf('"') != -1 && (a = a.replace(ta, "&quot;")), a.indexOf("'") != -1 && (a = a.replace(ua, "&#39;")), a.indexOf("\x00") != -1 && (a = a.replace(va, "&#0;")));
        this.friendlyName = a;
        this.capabilities = c || [];
        this.volume = d || null;
    ...
    f.Xb = function(a, b, c) {
        Oa(this, a) < 0 || C.m(this, "QUEUE_REMOVE", new chrome.cast.media.ta([a]), b, c, chrome.cast.media.timeout.u)
    };
    f.Zb = function(a, b, c) {
    ...
    function S() {
        return lb ? !!Q && Q.brands.length > 0 : !1
    }

    function sb() {
        return S() ? rb("Chromium") : (R("Chrome") || R("CriOS")) && !(S() ? 0 : R("Edge")) || R("Silk")
    };
    var tb = R("Gecko") && !(pb().toLowerCase().indexOf("webkit") != -1 && !R("Edge")) && !(R("Trident") || R("MSIE")) && !R("Edge"),
        ub = pb().toLowerCase().indexOf("webkit") != -1 && !R("Edge");
    !R("Android") || sb();
    sb();
    R("Safari") && (sb() || (S() ? 0 : R("Coast")) || (S() ? 0 : R("Opera")) || (S() ? 0 : R("Edge")) || (S() ? rb("Microsoft Edge") : R("Edg/")) || S() && rb("Opera"));
    var vb = {},
        T = null,
        wb = tb || ub || typeof q.btoa == "function",
        xb = function(a) {
    ...
    var U = function() {
        ...
        V = function(a) {
            var b = typeof a;
            return b == "object" && a || b == "function" ? "o" + (Object.prototype.hasOwnProperty.call(a, u) && a[u] || (a[u] = ++ma)) : b.slice(0, 1) + a
        };
    f = U.prototype;
    f.add = function(a) {
        this.g.set(V(a), a);
    ...
    var Db = function(a, b, c, d, e, g, k) {
        ...
        a.Ca(d, function(l) {
            l.status && l.status.length == 1 ? e && e(l.status[0]) : (l = new chrome.cast.Error(chrome.cast.v.SESSION_ERROR), g && g(l))
        }, g, k)
    };
    f = W.prototype;
    ...
    W.prototype.onMessage = function(a) {
        ...
        if (b = ab(this.R, a.sequenceNumber)) a.type == "error" ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
    ...
    chrome.cast.unescape = function(a) {
        return a.indexOf("&") != -1 ? "document" in q ? Ma(a) : Na(a) : a
    };
