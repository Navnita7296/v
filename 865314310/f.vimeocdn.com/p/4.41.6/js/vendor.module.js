...
let vu = function(e) {
        ...
        return n.setStreamIndex = function(e) {
            ...
            switch (e) {
                ...
                case "average":
                    const e = o(lu, this).getAverageSpeed(t, n),
                        i = ie.navigatorConnection;
                    if (i) {
                        if (!0 === o(fu, this).networkInformationApiAB || "variant" === o(fu, this).networkInformationApiAB) {
                            const t = 1e3 * (null == i ? void 0 : i.downlink) * 1e3;
                            return Math.max(e, t)
                        }
                        if ("variant_2" === o(fu, this).networkInformationApiAB) {
                            const r = o(lu, this).getAverageSpeedNetworkInformationApi(t, n);
                            return Math.max(e, r)
                        }
                    }
                    return e
...
let yu = function(e) {
        ...
        return n.shouldPowerUp = function(e, t, n) {
            ...
            const i = xo(this._options, "prevent_up_switch_not_visible"),
                o = !0 === (null == i ? void 0 : i.group) || "variant" === (null == i ? void 0 : i.group),
            ...
            const c = this._getStreamFromSpeed(u, this.BANDWIDTH_UPSWITCH_THRESHOLD, e);
...
let zu = function(t) {
        ...
        return r.deactivate = function() {
            ...
            this._restrictedStreamIndexes.length && (n = this._restrictedStreamIndexes[0]), null !== this._preloadStreamIndex && (n = this._preloadStreamIndex);
            let r = 0;
            ...
            return this._initializeManifest(e).then((() => {
                let e = this._streams[Yu][0];
                this._restrictedStreamIndexes.length && (e = this._streams[Yu][this._restrictedStreamIndexes[0]]), null !== this._preloadStreamIndex && (e = this._streams[Yu][this._preloadStreamIndex]), this._setUpSorcerer(this._video, {
                ...
                const t = this._streams[Yu].indexOf(e);
                for (const n in this._streams) this._streams[n].forEach(((e, t) => {
                    let r = this._getSegmentUrl(t, "init", n);
                    this._useRangeRequests(t, n) && this._streams[n][t].init_segment_range && (r = {
                        url: r,
                        byteRange: this._getRangeForSegment(t, "init", n)
                    }), this.sorcerer.addStream(`${e.mime_type}; codecs="${this._streams[n][t].codecs}"`, r)
                }));
                this.sorcerer.video.switchTo(t, !0, {
                    reasonForSwitch: 7
...
function ch(e, t, n) {
    ...
    return function() {
            var t, i, o, s, a;
            const u = [zu, vc, Tc, rs],
                c = e.video.ecdn && !(null != (t = e.request.flags) && t.ecdn_delta_updates);
            r = new Hc(n, u, {
                externalDisplays: [ko],
                mediaSourceScanner: {
                ...
                networkInformationApiAB: !(null == (a = e.request.ab_tests) || null == (a = a.network_information_api) || !a.group)
            })
    ...
    function l(n) {
        ...
        if (!(void 0 === s || "string" != typeof s || e.hidePrivateMethods && s.indexOf("_") > -1)) try {
            ...
            Ef.captureBreadcrumb("API message received", o, "api"), e = Array.isArray(a) ? a : null == a ? [] : [a], Promise.resolve(i.call.apply(i, [n].concat(T(e), [u]))).then((e => {
                let t;
                t = Array.isArray(a) || null == e ? a : e, d({
                    method: s,
                    value: t
                })
            })).catch(r.logError)
